...
namespace Sklep.Data.Data.CMS
{
    public class Strona
    {
        ...
        public string CiekawostkiMotoryzacja { get; set; }

        [Required(ErrorMessage = "Ciekawostka jest wymagana")]
        [Display(Name = "Ciekawostki motoryzacyjne")]
        public string InformacjeMotoryzacja { get; set; }

        [Required(ErrorMessage = "Informacja jest wymagana")]
        [Display(Name = "Informacje motoryzacyjne")]
